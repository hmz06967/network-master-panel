...
/// <reference path="/root/node_modules/xterm/typings/xterm.d.ts"/>

// Use tsc version (yarn watch)
import { Terminal } from /root/xterm.js/out/browser/public/Terminal';
import { AttachAddon } from /root/xterm.js/addons/xterm-addon-attach/out/AttachAddon';
import { FitAddon } from /root/xterm.js/addons/xterm-addon-fit/out/FitAddon';
import { SearchAddon, ISearchOptions } from /root/xterm.js/addons/xterm-addon-search/out/SearchAddon';
import { SerializeAddon } from /root/xterm.js/addons/xterm-addon-serialize/out/SerializeAddon';
import { WebLinksAddon } from /root/xterm.js/addons/xterm-addon-web-links/out/WebLinksAddon';
import { WebglAddon } from /root/xterm.js/addons/xterm-addon-webgl/out/WebglAddon';
import { Unicode11Addon } from /root/xterm.js/addons/xterm-addon-unicode11/out/Unicode11Addon';
import { LigaturesAddon } from /root/xterm.js/addons/xterm-addon-ligatures/out/LigaturesAddon';

// Use webpacked version (yarn package)
// import { Terminal } from /root/xterm.js/lib/xterm';
...
function addDomListener(element: HTMLElement, type: string, handler: /root/xterm.js.args: any[]) => any): void {
